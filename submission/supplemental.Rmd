...
**Table S3: Alpha Diversity Metrics OR in Tissue for Adenoma**
...
**Table S4: Alpha Diversity Metrics OR in Tissue for Unmatched Carcinoma Non-Carcinoma Samples**
...
**Table S5: Alpha Diversity Metrics OR in Tissue for Matched Carcinoma Non-Carcinoma Samples**
...
**Table S8: OR of Adenoma in Stool for each Individual Genera with Initial P-Value under 0.05**
...
colnames(temp_8) <- c("OR", "Lower Bound", "Upper Bound", "P-value", "BH", "Lowest Genera ID")
...
**Table S10: OR of Carcinoma in Stool for each Individual Genera with Initial P-Value under 0.05**
...
colnames(temp_10) <- c("OR", "Lower Bound", "Upper Bound", "P-value", "BH", "Lowest Genera ID")
...
**Table S11: OR of Carcinoma in Tissue for each Individual Genera with Initial P-Value under 0.05**

```{r supplemental_table11, echo=FALSE, message=FALSE, warning=FALSE}

temp_11 <- read_csv("../data/process/tables/select_genus_OR_tissue_composite.csv") %>% 
  mutate(bh = p.adjust(pvalue, method = "BH")) %>% filter(pvalue < 0.05) %>% 
  arrange(bh, pvalue, rr) %>% 
  mutate(rr = round(rr, digits = 2), 
         ci_lb = round(ci_lb, digits = 2), 
