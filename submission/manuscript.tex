...
evidence collected within this study on the associations between the
microbiota and CRC are much stronger for carcinoma then adenoma. A
strong reason for this may be in part due to the low power to detect
more subtle changes in the majority of studies that have been performed
to date.
...
biomarkers or individual microbes but do not critically investigate how
the community changes in CRC.
