...
discordance between stool and tissue also applies to the
mouth-associated genera with one noticeable skew being that
\emph{Fusobacterium} and \emph{Fusobacteriaceae} occur more often in the
top 10 of Random Forest models using matched versus unmatched tissue
samples {[}Figure S7B-C \& S7E-F{]}.
...
are clearly important to carcinoma classification but ourobservations
