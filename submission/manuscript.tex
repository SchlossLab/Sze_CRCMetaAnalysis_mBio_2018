...
meta-analysis. The reported AUC values are the AUCs for the application
of the model on the test sets. For the OTU-based models, hyperparameters
were fit splitting the dataset into training (80\% of samples) and
testing (20\%) sets. Within the OTU dataset, 10-fold cross validation
(5-fold cross validation for small datasets) was used to identify the
best hyperparameters. The original 80/20 split and fitting was repeated
100 times and the average AUC from these 100 repeats was reported. The
