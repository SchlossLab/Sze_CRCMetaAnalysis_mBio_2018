...
Mouth-associated genera were consistently in the top 5 OTUs or genera
with the highest relative risk of adenoma and carcinoma for both stool
and tissue. Using the whole community versus selected generea with the
highest and lowest relative risk, to build a prediction model, resulted
in similar classification success, based on Area Under the Curve (AUC),
for both adenoma and carcinoma using fecal and tissue samples. The most
important groups within the full community models consistently belonged
to genera such as \emph{Ruminococcus}, \emph{Bacteroides}, and
\emph{Roseburia} across studies. Overall, there were less associations
between the microbiota and adenoma and one reason why this may be is
that most studies were only adequately powered for large effect sizes.
...
adenoma and this may be in part due to the low power to detect more
