...
comparison correction {[}Table S3 \& S4{]}. Mouth-associated genera
significantly increased the ORs of carcinoma for stool samples and
included \emph{Fusobacterium}, \emph{Parvimonas}, \emph{Porphyromonas},
and \emph{Peptostreptococcus} {[}Table S3{]}. Conversely,
mouth-associated genera were not significantly associated with an
increased OR for carcinoma in tissue samples {[}Table S4{]}. The
significant OR taxa in tissue were \emph{Dorea} (decreased OR) and
\emph{Weissella} (increased OR). Overall, there was little direct
overlap in increased or decreased OR genera between both tumor type and
sample site.
