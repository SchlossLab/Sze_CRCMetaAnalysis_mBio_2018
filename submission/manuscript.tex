...
\textbf{\emph{Fecal Diversity is Lower in Those with Carcinoma:}} Using
power transformed and Z-score normalized alpha diversity metrics both
evenness and the Shannon diversity metrics in feces was lower in those
with carcinoma then in controls but not for tissue samples {[}Figure
1{]}. Using linear mixed-effects to control for study and variable
...
individual (P-value \textgreater{} 0.05).
