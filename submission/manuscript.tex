...
sequence processing utilized the R (v3.4.3) software package {[}39{]}.
For OTU richness, evenness, and Shannon diversity analysis, values were
power transformed using the rcompanion (v1.11.1) package {[}40{]} and
then Z-score normalized using the car (v2.1.6) package {[}41{]}. Testing
...
{[}42{]} to correct for study, repeat sampling of individuals (tissue
...
{[}43,44{]} by assessing how many individuals with and without disease
...
(v2.4.5) package {[}45{]}. Random Forest models were built using both
the caret (v6.0.78) and randomForest (v4.6.12) packages {[}46,47{]}.
Power analysis and estimations were made using the pwr (v1.2.1) and
statmod (v1.4.30) packages {[}48,49{]}. All figures were created using
both ggplot2 (v2.2.1) and gridExtra (v2.3) packages {[}50,51{]}.
...
multiple comparisons using the Benjamini-Hochberg method {[}52{]}. We
...
40. Mangiafico S. Rcompanion: Functions to support extension education
...
45. Oksanen J, Blanchet FG, Friendly M, Kindt R, Legendre P, McGlinn D,
...
46. Jed Wing MKC from, Weston S, Williams A, Keefer C, Engelhardt A,
...
47. Liaw A, Wiener M. Classification and regression by randomForest. R
News {[}Internet{]}. 2002;2:18--22. Available from:
\url{http://CRAN.R-project.org/doc/Rnews/}

\hypertarget{ref-pwr_citation_2017}{}
48. Champely S. Pwr: Basic functions for power analysis {[}Internet{]}.
2017. Available from: \url{https://CRAN.R-project.org/package=pwr}

\hypertarget{ref-statmod_citation_2016}{}
49. Giner G, Smyth GK. Statmod: Probability calculations for the inverse
gaussian distribution. R Journal. 2016;8:339--51.

\hypertarget{ref-ggplot2_citation_2009}{}
50. Wickham H. Ggplot2: Elegant graphics for data analysis
{[}Internet{]}. Springer-Verlag New York; 2009. Available from:
\url{http://ggplot2.org}

\hypertarget{ref-gridextra_citation_2017}{}
51. Auguie B. GridExtra: Miscellaneous functions for ``grid'' graphics
{[}Internet{]}. 2017. Available from:
\url{https://CRAN.R-project.org/package=gridExtra}

\hypertarget{ref-benjamini_controlling_1995}{}
52. Benjamini Y, Hochberg Y. Controlling the false discovery rate: A
