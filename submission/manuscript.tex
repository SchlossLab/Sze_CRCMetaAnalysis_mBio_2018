...
0.05). This reduction in evenness translated into small increases in the
odds ratio for adenoma (P-value = 0.035) and carcinoma stages of CRC
(P-value = 0.0021) while the reduction in Shannon diversity only
translated into an increased odds ratio for developing carcinomas
(P-value = 0.0069). Increases in mouth-associated microbes were commonly
...
gastrointestinal tract were correlated with a decreased OR for both
...
decreased OR genera between both stages and sample site.

When observing ORs with a P-value less than 0.05 there was almost no
...
{[}Table S8 \& S9{]}. Many of the genera that had ORs with a P-value
under 0.05 for colon tissue are also highly prevalent in contamination,
specifically, \emph{Novosphingobium}, \emph{Pseudomonas}, and
...
samples {[}Table S10 \& S11{]}. Finally, these data suggest that the
most significantly increased OR genera for tissue was \emph{Lepttrichia}
while in stool it was \emph{Peptostreptococcus} {[}Table S10 \& S11{]}.

\textbf{\emph{Select Community Models can Recapitulate Whole Community
Models:}} Since specific genera increased OR for carcinoma over
