...
allowed for the combination of data from all studies to assess for
differences in these broad scale community metrics as disease severity
...
diversity changed in a step-wise manner as disease severity increased.
There was a significant decrease in both evenness and Shannon diversity
from control to adenoma to carcinoma in stool (P-value = 0.025 and
0.043, respectively) {[}Figure 1A{]}. We next tested whether these
detectable differences in community resulted in significant increases in
RR. For fecal samples, a decrease in evenness resulted in a
...
Using the Bray-Curtis distance metric and PERMANOVA, it was also
possible to identify significant bacterial community changes, in
specific studies, for both carcinoma versus control and adenoma versus
control {[}Table S1 \& S2{]}.
