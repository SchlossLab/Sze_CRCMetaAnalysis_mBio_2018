...
The focus on biomarkers within stool makes sense since the current gold standard for diagnosis is a colonoscopy which can be time-consuming and is not without risks. Stool offers an easy and cost-effective way in which to stratify risk within the population. Although stool represents an easy and less invasive way to assess risk, it is not clear how reflective this sample is to what is actually happening on the adenoma or carcinoma. Some studies have begun to try and assess this in health and disease but are limited by their sample size [@flemer_tumour-associated_2017; @Flynn_preprint_2017]. Since the stool possibly represents an agregate community of the overall gastrointestinal (GI) tract, sampling the adenoma or carinoma directly might do a better job at identifying important microbes and could be drastically different then what is identified in stool. Sampling the tissue directly may provide clearer answers but it is not without problems. Due to bowel prep the communities left for sampling may not be the truly resident microbes but rather a collection of what is able to keep adhered to the mucosa. Further, these samples would contain much more host DNA then microbial DNA. Low biomass samples are very difficult to work with and results can end up being study dependent due to the randomness of contamination [@Salter_contamination_2014]. Due to these variables, one question our meta-analysis aims to answer is whether it is possible to find consistent patterns that emerge across studies regardless of whether they used stool or tissue samples.      

This intense focus on identifying biomarkers has identified mostly mouth-associated microbes as potential CRC-associated microbes in the GI tract [@kostic_genomic_2012; @baxter_microbiota-based_2016; @zeller_potential_2014]. The main bacteria of interest arising from this set of microbes has been those within the *Fusobacterium* genus. Yet, the question remains as to whether or not this is indeed the most important genera to be focusing on since many studies microbiota based studies identify a collection of oral microbes rather than single genera [@baxter_microbiota-based_2016; @zeller_potential_2014]. Based on this discrepency, the second question we want to answer with this meta-analysis is if there really is one dominant CRC-associated genera that can be identified across studies.    

The heavy focus on the identification of biomarkers has mostly dominated the study of CRC and has had an unattended consequence of reducing the focus on changes that occur within the underlying resident community.  This has been borne out by the majority of previous studies, both within stool and tissue, that have focused predominately on biomarkers as well as the only meta-analysis investigating this area [@shah_leveraging_2017]. Since it has not been investigated in detail the final question that this meta-analysis aims to answer is whether there are consistent detectable community differences as disease severity increases. 
