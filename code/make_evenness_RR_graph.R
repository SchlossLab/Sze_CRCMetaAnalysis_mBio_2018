### Code to create needed evenness diversity RR graphs
### Marc Sze
...
ggsave("results/figures/evenness_RR.pdf", shannon_RR, width = 8, height = 6, dpi = 300)
