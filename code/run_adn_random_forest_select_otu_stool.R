### Run Random Forest Analysis select OTU Level -- stool adenoma
...
write.csv(all_roc_data, "data/process/tables/adn_stool_rf_select_otu_roc.csv", row.names = F)
write.csv(all_comparisons, "data/process/tables/adn_stool_rf_select_otu_random_comparison_summary.csv", 
          row.names = F)
