...
write.csv(ind_RR_data, "data/process/tables/adn_select_genus_RR_stool_ind_results.csv", row.names = F)
write.csv(pooled_results, "data/process/tables/adn_select_genus_RR_stool_composite.csv", row.names = F)
