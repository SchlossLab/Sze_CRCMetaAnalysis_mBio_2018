...
write.csv(ind_counts_data, "data/process/tables/adn_select_genus_group_counts_summary.csv", row.names = F)
write.csv(ind_RR_data, "data/process/tables/adn_select_genus_OR_stool_ind_results.csv", row.names = F)
write.csv(pooled_results, "data/process/tables/adn_select_genus_OR_stool_composite.csv", row.names = F)
