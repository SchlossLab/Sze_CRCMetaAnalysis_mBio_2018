...
for(i in c(tissue_sets, both_sets)){
  ...
  write_csv(imp_table, paste("data/process/tables/adn_", i, "_tissue_imp_otu_table.csv", sep = ""))
...
write.csv(all_roc_data, "data/process/tables/adn_tissue_rf_otu_roc.csv", row.names = F)
write.csv(all_comparisons, "data/process/tables/adn_tissue_rf_otu_random_comparison_summary.csv", 
          row.names = F)
